...
import AddNewPost from "@/components/homePrivate/AddNewPost1";
  ...
  return (
    <>
      {/* <div
        ...
        onClick={handleEmoji}
      ></div> */}
      <div className="modal-global" style={{ display: propsContext?.modalPost.modalActivePost ? "flex" : "none" }}>
        <div className="closed" onClick={handleCloseModal}></div>
        <Popup
          popupActive={propsContext?.popupPost.popupActivePost ? propsContext?.popupPost.popupActivePost : false}
