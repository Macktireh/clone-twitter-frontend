...
const ModalAddComment: React.FC = () => {
  ...
  return (
    <>
      <div className="modal-global" style={{ display: propsContext?.modalComment.modalActiveComment ? "flex" : "none" }}>
        <div className="closed" onClick={handleCloseModal}></div>
        <Popup
          popupActive={propsContext?.popupComment.popupActiveComment ? propsContext?.popupComment.popupActiveComment : false}
