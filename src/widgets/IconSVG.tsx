...
const IconSVG: React.FC<TIconeName> = ({ iconName, fill, nameClass, handleClick }) => {
    ...
    switch (iconName) {
      ...
      case "more":
        return (
          ...
          >
            <g>
              <circle fill={fill ? fill : "#f1f1f1"} cx="17" cy="12" r="1.5"></circle>
              <circle fill={fill ? fill : "#f1f1f1"} cx="12" cy="12" r="1.5"></circle>
              <circle fill={fill ? fill : "#f1f1f1"} cx="7" cy="12" r="1.5"></circle>
              <path
                fill={fill ? fill : "#f1f1f1"}
        ...
        return (
          ...
          >
            <g>
              ...
              ></path>
              <circle fill={fill ? fill : "#f1f1f1"} cx="8.868" cy="8.309" r="1.542"></circle>
            </g>
          </svg>
        );
      case "gif":
        ...
        return (
          ...
          >
            <g>
              ...
              ></path>
              <circle fill={fill ? fill : "#f1f1f1"} cx="14.738" cy="9.458" r="1.478"></circle>
              <circle fill={fill ? fill : "#f1f1f1"} cx="9.262" cy="9.458" r="1.478"></circle>
            </g>
          </svg>
        );
      case "schedule":
        return (
          ...
          >
            <g>
              <path fill={fill ? fill : "#f1f1f1"} d="M-37.9 18c-.1-.1-.1-.1-.1-.2.1 0 .1.1.1.2z"></path>
              <path
                fill={fill ? fill : "#f1f1f1"}
        ...
        return (
          ...
          >
            <g>
              ...
              ></path>
              <circle fill={fill ? fill : "#f1f1f1"} cx="7.032" cy="8.75" r="1.285"></circle>
              <circle fill={fill ? fill : "#f1f1f1"} cx="7.032" cy="13.156" r="1.285"></circle>
              <circle fill={fill ? fill : "#f1f1f1"} cx="16.968" cy="8.75" r="1.285"></circle>
              <circle fill={fill ? fill : "#f1f1f1"} cx="16.968" cy="13.156" r="1.285"></circle>
              <circle fill={fill ? fill : "#f1f1f1"} cx="12" cy="8.75" r="1.285"></circle>
              <circle fill={fill ? fill : "#f1f1f1"} cx="12" cy="13.156" r="1.285"></circle>
              <circle fill={fill ? fill : "#f1f1f1"} cx="7.032" cy="17.486" r="1.285"></circle>
              <circle fill={fill ? fill : "#f1f1f1"} cx="12" cy="17.486" r="1.285"></circle>
            </g>
          </svg>
        );
      case "icon-notif-add":
      ...
      case "logout":
        return (
          ...
          >
            <g>
              <path fill={fill ? fill : "#f1f1f1"} d="M15.692 11.6l-5.14-5.14c-.292-.29-.767-.29-1.06 0s-.293.77 0 1.063l3.858 3.858H2.83c-.415 0-.75.337-.75.75s.335.75.75.75h10.52l-3.857 3.86c-.292.292-.292.767 0 1.06.147.146.34.22.53.22s.385-.073.53-.22l5.14-5.14c.293-.292.293-.766 0-1.06z"></path>
              <path fill={fill ? fill : "#f1f1f1"} d="M19.788 2.13H7.372c-1.264 0-2.292 1.03-2.292 2.293V7.38c0 .415.336.75.75.75s.75-.335.75-.75V4.424c0-.437.355-.792.792-.792h12.416c.437 0 .792.356.792.793V19.84c0 .436-.355.79-.792.79H7.372c-.437 0-.792-.354-.792-.79v-2.96c0-.413-.336-.75-.75-.75s-.75.337-.75.75v2.96c0 1.263 1.028 2.29 2.292 2.29h12.416c1.264 0 2.292-1.027 2.292-2.29V4.422c0-1.264-1.028-2.292-2.292-2.292z"></path>
            </g>
          </svg>
        );
      default:
