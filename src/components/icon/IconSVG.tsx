...
type TIconeName = { iconName: string; fill?: string; nameClass?: string };

const IconSVG: React.FC<TIconeName> = ({ iconName, fill, nameClass }) => {
  const renderIcon = (iconName: string) => {
    switch (iconName) {
      case "homeActive":
        return (
          <svg className={nameClass ? nameClass : ""} viewBox="0 0 24 24" aria-hidden="true">
            <g>
              <path
